...
Use this folder for locale-specific translation guidance that supplements `.pixicode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/pixicode/pull/12345

## Do Not Translate (Locale Additions)

- `PixiCode` (preserve casing)
