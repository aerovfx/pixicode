...
- PR #10018: https://github.com/anomalyco/pixicode/pull/10018
- PR #12935: https://github.com/anomalyco/pixicode/pull/12935

## Do Not Translate (Locale Additions)

- `PixiCode` (preserve casing in prose; keep `pixicode` only in commands, package names, paths, or code)
- `PixiCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
