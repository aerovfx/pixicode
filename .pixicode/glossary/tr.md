...
- PR #15835: https://github.com/anomalyco/pixicode/pull/15835

## Do Not Translate (Locale Additions)

- `PixiCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `pixicode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `PixiCode` in prose, `pixicode` only for exact technical identifiers
...
- Avoid changing `pixicode` to `PixiCode` inside commands, URLs, package names, or code literals
