...
- PR #13942: https://github.com/anomalyco/pixicode/pull/13942

## Do Not Translate (Locale Additions)

- `PixiCode` (preserve casing in prose; keep `pixicode` only when it is part of commands, package names, paths, or code)
- `PixiCode Zen`
- `PixiCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `pixicode` in prose when referring to the product name; use `PixiCode`
