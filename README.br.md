...
O PixiCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/pixicode/releases) ou em [pixibox.ai/download](https://pixibox.ai/download).
