...
const docs = `### Overview
Loads PixiCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>PixiCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>PixiCode Mono Sample</div>
    </div>
  ),
}
