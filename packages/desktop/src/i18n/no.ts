export const dict = {
  ...
  "desktop.menu.help.documentation": "PixiCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "PixiCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
