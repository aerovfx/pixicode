export const dict = {
  ...
  "desktop.menu.help.documentation": "PixiCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "PixiCode CLI binary is missing. Try reinstalling the desktop app.",
