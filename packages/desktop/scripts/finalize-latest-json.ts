...
const releaseId = process.env.PIXICODE_RELEASE
if (!releaseId) throw new Error("PIXICODE_RELEASE is required")

const version = process.env.PIXICODE_VERSION
if (!releaseId) throw new Error("PIXICODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "pixicode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "pixicode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "pixicode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "pixicode-desktop-linux-aarch64.rpm" },
  { key: "windows-x86_64-nsis", asset: "pixicode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "pixicode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "pixicode-desktop-darwin-aarch64.app.tar.gz",
  },
]
