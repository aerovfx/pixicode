...
export const dict = {
  ...
  "notFound.title": "No encontrado | pixicode",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "pixicode logo claro",
  "notFound.logoDarkAlt": "pixicode logo oscuro",
  ...
  "app.meta.description": "PixiCode - El agente de codificación de código abierto.",

  "home.title": "PixiCode | El agente de codificación IA de código abierto",

  "temp.title": "pixicode | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "pixicode zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por pixicode",
  ...
  "temp.screenshot.caption": "pixicode TUI con el tema tokyonight",
  "temp.screenshot.alt": "pixicode TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de pixicode claro",
  "temp.logoDarkAlt": "logo de pixicode oscuro",
  ...
  "home.what.title": "¿Qué es PixiCode?",
  "home.what.body":
    "PixiCode es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, PixiCode es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "PixiCode no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es PixiCode?",
  "home.faq.a1":
    "PixiCode es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso PixiCode?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar PixiCode?",
  "home.faq.a3.p1":
    "No necesariamente, PixiCode viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, PixiCode también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con PixiCode?",
  "home.faq.a4.p1":
    "Sí, PixiCode soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar PixiCode en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! PixiCode ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta PixiCode?",
  "home.faq.a6":
    "PixiCode es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es PixiCode de código abierto?",
  "home.faq.a8.p1": "Sí, PixiCode es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que PixiCode ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "PixiCode Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que PixiCode ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es PixiCode Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de PixiCode.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá PixiCode negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, PixiCode añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con PixiCode, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de PixiCode.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con PixiCode, puedes usar Zen con cualquier agente.",
  ...
  "black.meta.title": "PixiCode Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de PixiCode Black.",
  ...
  "black.title": "PixiCode Black | Precios",
  ...
  "black.workspace.title": "PixiCode Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a PixiCode Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de PixiCode Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "PixiCode Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con pixicode cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona pixicode",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia pixicode y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de pixicode.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de pixicode Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a PixiCode Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan PixiCode Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan PixiCode Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a PixiCode Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "PixiCode Go" como proveedor en tu configuración de pixicode para usar los modelos Go.',
  "workspace.lite.other.title": "Suscripción Go",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a PixiCode Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.title": "PixiCode Go",
  "workspace.lite.promo.description":
    "PixiCode Go es una suscripción de $10 al mes que proporciona acceso confiable a modelos de codificación abiertos populares con generosos límites de uso.",
  ...
  "download.title": "PixiCode | Descargar",
  "download.meta.description": "Descarga PixiCode para macOS, Windows y Linux",
  "download.hero.title": "Descargar PixiCode",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "PixiCode Terminal",
  "download.section.desktop": "PixiCode Desktop (Beta)",
  "download.section.extensions": "Extensiones PixiCode",
  "download.section.integrations": "Integraciones PixiCode",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar PixiCode a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", PixiCode funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "PixiCode es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque PixiCode funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en PixiCode.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "PixiCode | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a PixiCode para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "PixiCode opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es PixiCode Enterprise?",
  "enterprise.faq.a1":
    "PixiCode Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con PixiCode Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. PixiCode por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con PixiCode Enterprise?",
  "enterprise.faq.a4":
    "Sí. PixiCode no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "PixiCode | Marca",
  "brand.meta.description": "Guías de marca de PixiCode",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca PixiCode.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "PixiCode | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de PixiCode",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para PixiCode",
