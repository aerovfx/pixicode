...
import desktopAppIcon from "../../asset/lander/pixicode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://pixibox.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>pixibox.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g pixicode-ai")}>
                <code>
                  npm i -g <strong>pixicode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g pixicode-ai")}>
                <code>
                  bun add -g <strong>pixicode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/pixicode")}>
                <code>
                  brew install <strong>anomalyco/tap/pixicode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S pixicode")}>
                <code>
                  paru -S <strong>pixicode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask pixicode-desktop")}>
                <code>
                  brew install --cask <strong>pixicode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
