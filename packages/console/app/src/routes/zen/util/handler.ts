...
import { and, Database, eq, isNull, lt, or, sql } from "@pixicode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@pixicode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@pixicode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@pixicode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@pixicode-ai/console-core/util/date.js"
import { Identifier } from "@pixicode-ai/console-core/identifier.js"
import { Billing } from "@pixicode-ai/console-core/billing.js"
import { Actor } from "@pixicode-ai/console-core/actor.js"
import { WorkspaceTable } from "@pixicode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@pixicode-ai/console-core/model.js"
import { Subscription } from "@pixicode-ai/console-core/subscription.js"
import { BlackData } from "@pixicode-ai/console-core/black.js"
import { UserTable } from "@pixicode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@pixicode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@pixicode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@pixicode-ai/console-core/lite.js"
import { Resource } from "@pixicode-ai/console-resource"
...
export async function handler(
  ...
  const ADMIN_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // pixicode bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-pixicode-session") ?? ""
    const requestId = input.request.headers.get("x-pixicode-request") ?? ""
    const projectId = input.request.headers.get("x-pixicode-project") ?? ""
    const ocClient = input.request.headers.get("x-pixicode-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-pixicode-request")
          headers.delete("x-pixicode-session")
          headers.delete("x-pixicode-project")
          headers.delete("x-pixicode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://pixibox.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://pixibox.ai/workspace/${authInfo.workspaceID}/members`
