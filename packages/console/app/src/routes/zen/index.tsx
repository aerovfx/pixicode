...
import compareVideo from "../../asset/lander/pixicode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/pixicode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="pixicode:auth" content={loggedin() ? "true" : "false"} />
