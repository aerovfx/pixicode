import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@pixicode-ai/sdk/v2"
import { SessionTurn } from "@pixicode-ai/ui/session-turn"
import { SessionReview } from "@pixicode-ai/ui/session-review"
import { DataProvider } from "@pixicode-ai/ui/context"
import { FileComponentProvider } from "@pixicode-ai/ui/context/file"
import { WorkerPoolProvider } from "@pixicode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@pixicode-ai/ui/logo"
import { IconButton } from "@pixicode-ai/ui/icon-button"
import { ProviderIcon } from "@pixicode-ai/ui/provider-icon"
import { createDefaultOptions } from "@pixicode-ai/ui/pierre"
import { iife } from "@pixicode-ai/util/iife"
import { Binary } from "@pixicode-ai/util/binary"
...
import { MessageNav } from "@pixicode-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { FileSSR } from "@pixicode-ai/ui/file-ssr"
import { clientOnly } from "@solidjs/start"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@pixicode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/pixicode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | PixiCode</Title>
              </Show>
              <Meta name="description" content="pixicode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/pixicode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
