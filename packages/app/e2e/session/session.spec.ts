...
const shareDisabled = process.env.PIXICODE_DISABLE_SHARE === "true" || process.env.PIXICODE_DISABLE_SHARE === "1"
...
test("session can be shared and unshared via header button", async ({ page, sdk, gotoSession }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (PIXICODE_DISABLE_SHARE).")
