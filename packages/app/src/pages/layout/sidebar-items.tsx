...
import { Avatar } from "@pixicode-ai/ui/avatar"
import { HoverCard } from "@pixicode-ai/ui/hover-card"
...
import { Tooltip } from "@pixicode-ai/ui/tooltip"
import { getFilename } from "@pixicode-ai/util/path"
import { type Message, type Session, type TextPart, type UserMessage } from "@pixicode-ai/sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"
import { hasProjectPermissions } from "./helpers"
import { sessionPermissionRequest } from "../session/composer/session-request-tree"

const PIXICODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === PIXICODE_PROJECT_ID ? "/logo.png" : props.project.icon?.override
          }
