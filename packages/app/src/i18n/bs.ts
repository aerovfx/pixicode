export const dict = {
  ...
  "dialog.provider.pixicode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.pixicode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.pixicodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u PixiCode-u.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.pixicodeZen.visit.prefix": "Posjeti ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u PixiCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u PixiCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u pixicode.json",
  ...
  "dialog.server.description": "Promijeni na koji se PixiCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija PixiCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PixiCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (pixicode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: PixiCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni PixiCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u PixiCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako PixiCode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu PixiCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se PixiCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju PixiCode-a.",
