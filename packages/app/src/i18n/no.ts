...
export const dict = {
  ...
  "dialog.provider.pixicode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.pixicode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.pixicodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i PixiCode.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.pixicodeZen.visit.prefix": "Besøk ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i PixiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i PixiCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i pixicode.json",
  ...
  "dialog.server.description": "Bytt hvilken PixiCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av PixiCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til PixiCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (pixicode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at PixiCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør PixiCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for PixiCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan PixiCode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan PixiCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når PixiCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av PixiCode.",
