export const dict = {
  ...
  "dialog.provider.pixicode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.pixicode.tagline": "Reliable optimized models",
  "dialog.provider.pixicodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in PixiCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.pixicodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.pixicodeZen.visit.prefix": "Visit ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in PixiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in PixiCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in pixicode.json",
  ...
  "dialog.directory.serverUnavailable": "Server not connected. Start the backend (e.g. npm run dev:serve) to browse folders, or enter a path below.",
  "dialog.directory.enterPath": "Enter project path",
  "dialog.directory.enterPathPlaceholder": "/path/to/project",
  "dialog.directory.enterPathRequired": "Please enter a project path",
  "dialog.directory.openPath": "Open",

  "dialog.server.title": "Servers",
  "dialog.server.description": "Switch which PixiCode server this app connects to.",
  ...
  "toast.file.saveFailed.description": "Check the file path and try again",
  "session.file.editInEditor": "Edit in editor",
  "session.file.saveShortcut": "Save (Ctrl+S)",
  ...
  "toast.update.description": "A new version of PixiCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the PixiCode team",
  ...
  "error.chain.checkConfig": "Check your config (pixicode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, PixiCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.clearNotifications": "Clear notifications",

  "app.name.desktop": "PixiCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the PixiCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for PixiCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how PixiCode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how PixiCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when PixiCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of PixiCode.",
