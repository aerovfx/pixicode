...
export const dict = {
  ...
  "dialog.provider.pixicode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.pixicode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.pixicodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "PixiCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve PixiCode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.pixicodeZen.visit.prefix": "",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve PixiCode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak PixiCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler pixicode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi PixiCode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "PixiCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı PixiCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (pixicode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: PixiCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "PixiCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "PixiCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "PixiCode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "PixiCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "PixiCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "PixiCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "PixiCode'un en son sürümünü kullanıyorsunuz.",
