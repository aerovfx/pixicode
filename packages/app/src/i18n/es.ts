export const dict = {
  ...
  "dialog.provider.pixicode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.pixicode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.pixicodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en PixiCode.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.pixicodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.pixicodeZen.visit.prefix": "Visita ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en PixiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en PixiCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en pixicode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de PixiCode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de PixiCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de PixiCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (pixicode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, PixiCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor PixiCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para PixiCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve PixiCode en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de PixiCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia PixiCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de PixiCode.",
