export const dict = {
  ...
  "dialog.provider.pixicode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.pixicode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.pixicodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no PixiCode.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.pixicodeZen.visit.prefix": "Visite ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no PixiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no PixiCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em pixicode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor PixiCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do PixiCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do PixiCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (pixicode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: PixiCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "PixiCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor PixiCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do PixiCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o PixiCode aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o PixiCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o PixiCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do PixiCode.",
