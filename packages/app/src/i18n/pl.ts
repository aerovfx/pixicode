export const dict = {
  ...
  "dialog.provider.pixicode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.pixicode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.pixicodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez PixiCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w PixiCode.",
  ...
  "provider.connect.pixicodeZen.line1":
    "PixiCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.pixicodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.pixicodeZen.visit.link": "pixibox.ai/zen",
  "provider.connect.pixicodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w PixiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w PixiCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w pixicode.json",
  ...
  "dialog.server.description": "Przełącz serwer PixiCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja PixiCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PixiCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (pixicode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "PixiCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla PixiCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd PixiCode na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw PixiCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania PixiCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji PixiCode.",
