...
beforeAll(async () => {
  ...
  mock.module("@pixicode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@pixicode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@pixicode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@pixicode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
