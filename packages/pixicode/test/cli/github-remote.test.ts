...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pixicode.git")).toEqual({ owner: "sst", repo: "pixicode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pixicode")).toEqual({ owner: "sst", repo: "pixicode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pixicode.git")).toEqual({ owner: "sst", repo: "pixicode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pixicode")).toEqual({ owner: "sst", repo: "pixicode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pixicode.git")).toEqual({ owner: "sst", repo: "pixicode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pixicode")).toEqual({ owner: "sst", repo: "pixicode" })
})
