...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PIXICODE_CALLER", () => {
    process.env["PIXICODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PIXICODE_CALLER", () => {
    process.env["PIXICODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PIXICODE_CALLER", () => {
    process.env["PIXICODE_CALLER"] = "unknown"
