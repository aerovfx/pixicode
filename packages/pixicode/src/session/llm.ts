...
export namespace LLM {
  ...
  export async function stream(input: StreamInput) {
    ...
    return streamText({
      ...
      headers: {
        ...(input.model.providerID.startsWith("pixicode")
          ? {
              "x-pixicode-project": Instance.project.id,
              "x-pixicode-session": input.sessionID,
              "x-pixicode-request": input.user.id,
              "x-pixicode-client": Flag.PIXICODE_CLIENT,
            }
