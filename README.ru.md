...
PixiCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/anomalyco/pixicode/releases) или с [pixibox.ai/download](https://github.com/aerovfx/pixicode/download).
