...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/pixicode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/pixicode...\n")
...
console.log("Fetching npm all-time downloads for pixicode-ai...\n")
const npmDownloads = await fetchNpmDownloads("pixicode-ai")
