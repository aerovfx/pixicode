...
PixiCode はデスクトップアプリとしても利用できます。**macOS (Apple Silicon):** [.dmg をダウンロード](https://github.com/aerovfx/pixicode/raw/main/release/dmg/PixiCode%20Dev_1.2.17_aarch64.dmg)。[releases](https://github.com/aerovfx/pixicode/releases) または [pixibox.ai/download](https://pixibox.ai/download) からもどうぞ。

| プラットフォーム      | ダウンロード                          |
| --------------------- | ------------------------------------- |
| macOS (Apple Silicon) | [.dmg をダウンロード](https://github.com/aerovfx/pixicode/raw/main/release/dmg/PixiCode%20Dev_1.2.17_aarch64.dmg) |
